        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <s:select list="#depts" name="employee.department.id" listKey="id" listValue="name"
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <table>
                            <tr>
                                <td>
                                    <s:select list="#roles" name="" listKey="id" listValue="name" multiple="true"
                                ...
                                <td>
                                    <s:select list="employee.roles" name="employee.roles.id" listKey="id"
